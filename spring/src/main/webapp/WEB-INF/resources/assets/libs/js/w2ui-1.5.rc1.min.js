        ...
        $.fn.w2grid = function(a) {
            ...
            expand: function(a) {
                ...
                if (Array.isArray(e)) {
                    ...
                    h.height() < j && h.css({
                        ...
                        height: j + "px"
                    }), $("#grid_" + this.name + "_rec_" + d).attr("expanded", "yes").addClass("w2ui-expanded"), $("#grid_" + this.name + "_frec_" + d).attr("expanded", "yes").addClass("w2ui-expanded"), $("#grid_" + this.name + "_cell_" + this.get(a, !0) + "_expand div").html("<input type='radio' checked>"), c.w2ui.expanded = !0, this.trigger($.extend(f, {
                        phase: "after"
                    })), this.resizeRecords()
                }
                return !0
            ...
            collapse: function(a) {
                ...
                if (Array.isArray(g)) {
                    ...
                    if (h.isCancelled === !0) return !1;
                    $("#grid_" + this.name + "_rec_" + f).removeAttr("expanded").removeClass("w2ui-expanded"), $("#grid_" + this.name + "_frec_" + f).removeAttr("expanded").removeClass("w2ui-expanded"), $("#grid_" + this.name + "_cell_" + this.get(a, !0) + "_expand div").html("<input type='radio'>"), $("#grid_" + c.name + "_rec_" + f + "_expanded").css("height", "0px"), $("#grid_" + c.name + "_frec_" + f + "_expanded").css("height", "0px"), setTimeout(function() {
            ...
            resizeRecords: function() {
                ...
                p < 43 && (p = 43) /* origin p<34&&(p=34) */ , null != this.lineNumberWidth && (p = this.lineNumberWidth);
            ...
            getLineHTML: function(a, b, c) {
                if (c != null) a = c;
                return "<div style='text-align:center; font-size:20px;'>" /* origin <div> */ + a + "</div>"
            },
    ...
    w2confirm = function(a, b, c) {
        var d = jQuery,
            ...
            f = {
                ...
                height: d("#w2ui-popup").length > 0 ? 170 : 280,
                yes_text: "Yes",
                yes_class: "",
                yes_style: "",
                yes_callBack: null,
